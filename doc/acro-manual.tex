...
\begin{options}
  ...
  \keyval{threshold}{num}\Module{pages,seq}\Default{3}
    ...
    \meta{num1}--\meta{num2}.
  \keyval{fill}{code}\Module{pages}\Default{\cs*{acrodotfill}}
...
\begin{options}
  ...
  \keybool{longtable}\Module{patch}\Default{true}
...
\begin{templates}
  ...
  \tmpl{tabularray}
    A\sinceversion{3.7a} style that uses a custom table environment
