...
\begin{options}
  \keychoice{use}{\default{true},false,indexed}\Module{index}\Default{false}
    Enable indexing.  If \code{indexed} is chosen only the acronyms for which
    the property \property{index} has been set are indexed.  With \code{true}
    \emph{all} acronyms are indexed.
