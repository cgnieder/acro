...
\NewAcroCommand \iacp {m}
  { \acroindefinite \acroplural \AcroUseTemplate {first} {#1} }
\NewAcroCommand \Ac {m}
...
\NewAcroCommand \Iacp {m}
  { \acroupper \acroindefinite \acroplural \AcroUseTemplate {first} {#1} }
...
\NewAcroCommand \iacsp {m}
  { \acroindefinite \acroplural \AcroUseTemplate {short} {#1} }
\NewAcroCommand \Acs {m}
...
\NewAcroCommand \Iacsp {m}
  { \acroupper \acroindefinite \acroplural \AcroUseTemplate {short} {#1} }
...
\NewAcroCommand \acf {m}
  { \acrofirst \AcroUseTemplate {first} {#1} }
\NewAcroCommand \acfp {m}
  { \acrofirst \acroplural \AcroUseTemplate {first} {#1} }
\NewAcroCommand \iacf {m}
  { \acrofirst \acroindefinite \AcroUseTemplate {first} {#1} }
\NewAcroCommand \Acf {m}
  { \acrofirst \acroupper \AcroUseTemplate {first} {#1} }
\NewAcroCommand \Acfp {m}
  { \acrofirst \acroplural \acroupper \AcroUseTemplate {first} {#1} }
\NewAcroCommand \Iacf {m}
  { \acrofirst \acroupper \acroindefinite \AcroUseTemplate {first} {#1} }

\NewAcroCommand \acshow {m}
  { \AcroUseTemplate {show} {#1} }
  
% --------------------------------------------------------------------------
\AcroDeclareEnding {plural} {s} {s}
...
\AcroNewTemplate[heading] {section}
  { \section { \acrotranslate {list-name} } }

\AcroNewTemplate[heading] {section*}
  { \section* { \acrotranslate {list-name} } }

\AcroNewTemplate[heading] {addsec}
  { \addsec { \acrotranslate {list-name} } }
...
% translations:
% list name
\AcroDeclareTranslation {list-name}
  {
    Fallback   = Acronyms ,
    English    = Acronyms ,
    French     = Acronymes ,
...
% following page
\AcroDeclareTranslation {next-page}
  {
    Fallback   = f. ,
    English    = f. ,
    German     = f. ,
...
% following pages
\AcroDeclareTranslation {next-pages}
  {
    Fallback   = ff. ,
    English    = ff. ,
    German     = ff. ,
