% ----------------------------------------------------------------------------
% the ACRO package - upgrade module
% 
%   Typeset Acronyms
% 
% --------------------------------------------------------------------------
...
\cs_new_protected:Npn \acro_deprecate_function:NN #1#2
  {
    \cs_set:Npn #1
      {
        \msg_expandable_error:nnnn {acro} {function-deprecated} {#1} {#2}
        #2
      }
  }
...
\cs_new_protected:Npn \acro_remove_function:N #1
  {
    \cs_set:Npn #1
      { \msg_expandable_error:nnn {acro} {function-removed} {#1} }
  }
...
\acro_deprecate_function:NN \ProvideAcroEnding \AcroDeclareEnding
