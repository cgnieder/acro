...
% --------------------------------------------------------------------------
\DeclareRelease{2}{2020-03-07}{acro2.sty}
...
\DeclareCurrentRelease{}{\c_acro_date_tl}
...
\msg_new:nnn {acro} {version}
  {
    Please~ specify~ version~ 2~ by~ saying~ \token_to_str:N
    \usepackage{acro}[=v2]
  }
...
\keys_define:nn {acro/package}
  {
    ...
    version     .choice: ,
    version / 2 .code:n      = \msg_error:nn {acro} {version} \file_input_stop: ,
    version / 3 .code:n      =  ,
    version     .initial:n   = 3 ,
