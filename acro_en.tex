...
\begin{commands}
  ...
  \command*{acro_check_and_mark_if:nn}[ \marg{boolean expression} \marg{id}]
    ...
    inside \cs{NewAcroCommand} and friends implicitly.
  ...
  \command*{acro_mark_as_used:n}[ \marg{id}]
    Explicitly use the acronym \meta{id}.  This is the expl3 macro applied to
    all entries in \cs{acuse}.
  ...
  \command*{acro_for_all_acronyms_do:n}[ \marg{code}]
    ...
    \meta{code} you can refer to the \meta{id} of an acronym with
    \verbcode+#1+.
\end{commands}
