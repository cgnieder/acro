...
\begin{beschreibung}
 ...
 be sorted automatically. This option needs the experimental package \paket*{l3sort}
 (from the \paket{l3experimental} bundle). This option can only be set in the
